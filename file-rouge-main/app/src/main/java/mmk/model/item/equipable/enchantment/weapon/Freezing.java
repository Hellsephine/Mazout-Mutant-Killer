 ...
 */
public class Freezing extends AEnchantment {
    ...
    public int use(APersonnage personnage, int degattheorique) {
        if(personnage.isPersonnageState(EPersonnageState.FREEZING))
            return super.use(personnage, degattheorique);

        personnage.removePa(1);
        personnage.addPersonnageState(EPersonnageState.FREEZING);
        return super.use(personnage, degattheorique);
